    ...
    <div class="md:min-h-screen flex flex-col justify-center items-center md:mt-0 mt-10 md:p-0 p-10" id="Projects">
        ...
        <div class="flex md:flex-row flex-col md:space-x-10 md:p-10 md:space-y-0 space-y-10">
            ...
            <div class="flex flex-col space-y-3 relative">
                ...
                <img src="@/assets/images/vue.svg" class="w-8 absolute bottom-14 right-2">
                <h2 class="text-center text-2xl font-bold borde-top">photoAcCars</h2>
            </div>
            <div class="flex flex-col space-y-3 relative">
                <a href="https://covid19-cnelsuarez.herokuapp.com/" target="blank">
                    <img src="@/assets/images/COVID.png" class="projects-imgs">
                </a>
