		...
		<div class="principal">
			<router-link to='/'>
				<lord-icon
					...
					colors="primary:#dbb62e,secondary:#808080"
					style="width:70px;height:70px;"
					class="m-7 lg:float-right"
				>
				</lord-icon>	
			</router-link>
			<div class="flex">
...
<style scoped>
	...
	li {
		...
		@apply lg:text-2xl md:text-2xl text-xl;
	}


	li:hover {
		background: linear-gradient(to right, #eddbb2 20%, #DBB62E 40%, #DBB62E 60%, #DBB62E 80%);
